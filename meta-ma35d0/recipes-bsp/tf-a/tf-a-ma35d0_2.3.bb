...
do_compile() {
    ...
    TFA_OPT=" NEED_BL31=yes NEED_BL33=yes MA35D0_PMIC=${TFA_PMIC} MA35D0_CPU_CORE=${TFA_CPU_VOLTAGE}"
    ...
    if [ "${TFA_LOAD_SCP}" = "yes" ]; then
        ...
        if [ "${TFA_SCP_M4}" = "no" ]; then
            TFA_OPT="${TFA_OPT} MA35D0_SCPBL2_BASE=${TFA_SCP_BASE}"
        fi
    fi
    if ${@bb.utils.contains('MACHINE_FEATURES', 'optee', 'true', 'false', d)}; then
        ...
        if echo ${TFA_DTB} | grep -q "custom"; then
            ...
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=${DSIZE} \
                MA35D0_DDR_MAX_SIZE=${TFA_DDR_SIZE} \
                MA35D0_DRAM_S_BASE=${SBASE} \
                MA35D0_BL32_BASE=${SBASE} -C ${S} realclean
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=${DSIZE} \
                MA35D0_DDR_MAX_SIZE=${TFA_DDR_SIZE} \
                MA35D0_DRAM_S_BASE=${SBASE} \
                MA35D0_BL32_BASE=${SBASE} -C ${S} all
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=${DSIZE} \
                MA35D0_DDR_MAX_SIZE=${TFA_DDR_SIZE} \
                MA35D0_DRAM_S_BASE=${SBASE} \
                MA35D0_BL32_BASE=${SBASE} -C ${S} fiptool
	elif echo ${TFA_DTB} | grep -q "128"; then
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=0x07800000 \
                MA35D0_DDR_MAX_SIZE=0x8000000 \
                MA35D0_DRAM_S_BASE=0x87800000 \
                MA35D0_BL32_BASE=0x87800000 -C ${S} realclean
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=0x07800000 \
                MA35D0_DDR_MAX_SIZE=0x8000000 \
                MA35D0_DRAM_S_BASE=0x87800000 \
                MA35D0_BL32_BASE=0x87800000 -C ${S} all
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=0x07800000 \
                MA35D0_DDR_MAX_SIZE=0x8000000 \
                MA35D0_DRAM_S_BASE=0x87800000 \
                MA35D0_BL32_BASE=0x87800000-C ${S} fiptool
            ...
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=0x3F800000 \
                MA35D0_DDR_MAX_SIZE=0x40000000 \
                MA35D0_DRAM_S_BASE=0xBF800000 \
                MA35D0_BL32_BASE=0xBF800000 -C ${S} realclean
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=0x3F800000 \
                MA35D0_DDR_MAX_SIZE=0x40000000 \
                MA35D0_DRAM_S_BASE=0xBF800000 \
                MA35D0_BL32_BASE=0xBF800000 -C ${S} all
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=0x3F800000 \
                MA35D0_DDR_MAX_SIZE=0x40000000 \
                MA35D0_DRAM_S_BASE=0xBF800000 \
                MA35D0_BL32_BASE=0xBF800000-C ${S} fiptool
	elif echo ${TFA_DTB} | grep -q "512"; then
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=0x1F800000 \
                MA35D0_DDR_MAX_SIZE=0x20000000 \
                MA35D0_DRAM_S_BASE=0x9F800000 \
                MA35D0_BL32_BASE=0x9F800000 -C ${S} realclean
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=0x1F800000 \
                MA35D0_DDR_MAX_SIZE=0x20000000 \
                MA35D0_DRAM_S_BASE=0x9F800000 \
                MA35D0_BL32_BASE=0x9F800000 -C ${S} all
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D0_DRAM_SIZE=0x1F800000 \
                MA35D0_DDR_MAX_SIZE=0x20000000 \
                MA35D0_DRAM_S_BASE=0x9F800000 \
                MA35D0_BL32_BASE=0x9F800000-C ${S} fiptool	
	fi
    else
       oe_runmake PLAT=${PLATFORM} ${TFA_OPT} -C ${S} realclean
       oe_runmake PLAT=${PLATFORM} ${TFA_OPT} -C ${S} all
