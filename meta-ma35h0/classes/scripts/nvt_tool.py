    ...
    if image_id == IMG_SD:
        ...
        if os.path.isfile(image_path):
            ...
            if args.secure_boot == "no":
                ...
                if os.path.exists(f"enc_bl2-ma35h0-sdcard.dtb"):
                    os.remove(f"enc_bl2-ma35h0-sdcard.dtb")
                if os.path.exists(f"enc_bl2-ma35h0-sdcard.bin"):
                    os.remove(f"enc_bl2-ma35h0-sdcard.bin")
            else:
                ...
                shutil.copy("conv/enc_bl2-ma35h0.dtb", f"enc_bl2-ma35h0-sdcard.dtb")
                shutil.copy("conv/enc_bl2-ma35h0.bin", f"enc_bl2-ma35h0-sdcard.bin")
                ...
                data = json.load(open(os.path.join(args.nuwriter_dir, f"pack-sdcard.json")))
                data["image"][2]["file"]   = f"enc_bl2-ma35h0-sdcard.dtb"
                data["image"][3]["file"]   = f"enc_bl2-ma35h0-sdcard.bin"
                data["image"][8]["offset"] = str((BOOT_SPACE_ALIGNED + IMAGE_ROOTFS_ALIGNMENT) * 1024)
                with open(f"nuwriter/pack-sdcard.json", "w") as f:
                    json.dump(data, f, indent=2)
        ...
        if args.secure_boot == "no":
            ...
            subprocess.run(cmd, check=True)
            cmd = ["dd", f"if={args.deploy_dir}/bl2-ma35h0.dtb", f"of={SDCARD}", "conv=notrunc", f"seek=256", f"bs=512"]
            subprocess.run(cmd, check=True)
            cmd = ["dd", f"if={args.deploy_dir}/bl2-ma35h0.bin", f"of={SDCARD}", "conv=notrunc", f"seek=384", f"bs=512"]
            subprocess.run(cmd, check=True)
        else:
            ...
            subprocess.run(cmd, check=True)
            cmd = ["dd", f"if={args.deploy_dir}/enc_bl2-ma35h0-sdcard.dtb", f"of={SDCARD}", "conv=notrunc", f"seek=256", f"bs=512"]
            subprocess.run(cmd, check=True)
            cmd = ["dd", f"if={args.deploy_dir}/enc_bl2-ma35h0-sdcard.bin", f"of={SDCARD}", "conv=notrunc", f"seek=384", f"bs=512"]
            subprocess.run(cmd, check=True)
        ...
        if os.path.isfile(image_path):
            ...
            if args.secure_boot == "no":
                ...
                if os.path.exists(f"enc_bl2-ma35h0-nand.dtb"):
                    os.remove(f"enc_bl2-ma35h0-nand.dtb")
                if os.path.exists(f"enc_bl2-ma35h0-nand.bin"):
                    os.remove(f"enc_bl2-ma35h0-nand.bin")
            else:
                ...
                shutil.copy("conv/enc_bl2-ma35h0.dtb", f"enc_bl2-ma35h0-nand.dtb")
                shutil.copy("conv/enc_bl2-ma35h0.bin", f"enc_bl2-ma35h0-nand.bin")
                lines = open(f"conv/header_key.txt").read().splitlines()
                otp = {"publicx": lines[5], "publicy": lines[6], "aeskey":  lines[1]}
                ...
                data["image"][1]["file"]   = f"enc_bl2-ma35h0-nand.dtb"
                data["image"][2]["file"]   = f"enc_bl2-ma35h0-nand.bin"
        ...
        if os.path.isfile(image_path):
            ...
            if args.secure_boot == "no":
                ...
                if os.path.exists(f"enc_bl2-ma35h0-spinand.dtb"):
                    os.remove(f"enc_bl2-ma35h0-spinand.dtb")
                if os.path.exists(f"enc_bl2-ma35h0-spinand.bin"):
                    os.remove(f"enc_bl2-ma35h0-spinand.bin")
            else:
                ...
                shutil.copy("conv/enc_bl2-ma35h0.dtb", f"enc_bl2-ma35h0-spinand.dtb")
                shutil.copy("conv/enc_bl2-ma35h0.bin", f"enc_bl2-ma35h0-spinand.bin")
                ...
                data["image"][1]["file"]   = f"enc_bl2-ma35h0-spinand.dtb"
                data["image"][2]["file"]   = f"enc_bl2-ma35h0-spinand.bin"
        ...
        if os.path.isfile(image_path):
            ...
            if args.secure_boot == "no":
                ...
                if os.path.exists(f"enc_bl2-ma35h0-spinor.dtb"):
                    os.remove(f"enc_bl2-ma35h0-spinor.dtb")
                if os.path.exists(f"enc_bl2-ma35h0-spinor.bin"):
                    os.remove(f"enc_bl2-ma35h0-spinor.bin")
            else:
                ...
                shutil.copy("conv/enc_bl2-ma35h0.dtb", f"enc_bl2-ma35h0-spinor.dtb")
                shutil.copy("conv/enc_bl2-ma35h0.bin", f"enc_bl2-ma35h0-spinor.bin")
                ...
                data["image"][1]["file"]   = f"enc_bl2-ma35h0-spinor.dtb"
                data["image"][2]["file"]   = f"enc_bl2-ma35h0-spinor.bin"
